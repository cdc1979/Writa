...
//    self.previewerIframeDocument.write('<link href="/Scripts/dropzone/css/dropzone.css" rel="stylesheet" /><script src="//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script><script src="/Scripts/dropzone/dropzone.min.js"></script><script src="/Scripts/customdropzone.js"></script>');
  ...
  EpicEditor.prototype.preview = function () {
    ...
    //self.previewer.innerHTML = self.previewer.innerHTML.replace('<img src="" alt="image">', '<div class="dropzone"></div>')
    //self.previewer.innerHTML = self.previewer.innerHTML.replace('<img src alt="image">', '<div class="dropzone"></div>')
